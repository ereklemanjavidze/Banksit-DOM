...
const imgTarger = document.querySelectorAll('img[data-src]');
...
imgTarger.forEach(img => imgObserver.observe(img));
...
// massage.textContent='we are cookied for improved functionality and analytics';
message.innerHTML =
...
const alertH1 = function (e) {
  alert('addEventListener:great! you are rading the heading :D');
};
